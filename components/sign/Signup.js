      ...
      <form onSubmit={postDatumUp} className='mt-12 flex flex-col items-center'>
        ...
        {loading && alert === null ? (
          <div className='w-52 mt-5 h-9 rounded-md bg-emerald-200 shadow relative flex justify-center'>
            <ImSpinner9 className='tracking-wide text-emerald-500 text-2xl font-semibold absolute top-[17.5%] animate-spin' />
          </div>
        ) : (
          <button
            type='submit'
          ...
          >
            <p className='tracking-wide text-emerald-500 font-semibold absolute top-[17%]'>
              Signup
            </p>
          </button>
        )}
